...
**Westin W3 Finesse Jig 3rd** är alternativet om jiggfisket dominerar. 221 cm gör det lämpligt för kast från båt och vertikalfiske på djupare vatten. Kastvikt 7–28 g täcker tyngre jiggar för höstabborre och djupgående gös. EUKTLTSG-ringarna är optimerade för flätlina och ger fri lineglidning utan friktion.
