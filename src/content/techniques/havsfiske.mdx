...
targetSpecies: ["havsoring", "lax", "abborre"]
difficulty: "mellannivå"
topDestinations: ["bohuslan-skargard", "stockholms-skargard", "gotland", "morrum", "vanern"]
...
Mer om grunderna finns under [spinnfiske](/teknik/spinnfiske/).
...
Mer om flugteknik finns under [flugfiske](/teknik/flugfiske/).
...
Pilkfiske är grundtekniken för torsk på Bohuskusten och sej, långa och bleka i Skagerraks djupvatten. Vill du djupfiska vertikalt efter abborre och gös i skärgård länkas det till [vertikalfiske](/teknik/vertikalfiske/) och [jiggfiske](/teknik/jiggfiske/).

### Trolling

Dragfiske från framrörlig båt med ett eller flera spön. Tillåtet i havet men **förbjudet i fredningsområden för lax och öring**. Kontrollera fredningskartan för din kust inför fisket. I Östersjön gäller att icke fenklippta laxar ska omedelbart återutsättas vid trolling. Mer om grundtekniken under [trolling](/teknik/trolling/).
...
Läs mer under [havsöring](/arter/havsoring/).
...
Abborren är en sötvattensart som klarar bräckt vatten och är talrik i Östersjöns skärgårdar. Fiskas med spinnbeten, jigg och dropshot på grunt vatten. Läs mer under [abborre](/arter/abborre/).
