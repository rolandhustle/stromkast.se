...
description: "Moderataction jerkbaitspoe for gaedda med spigot-skarv och EVA-skumhandtag. Prisvaert alternativ for den som vill prova jerkbaitfiske."
...
rating: 3.9
pros:
  - "Prisvaert jerkbaitspoe for gaedda"
  - "Spigot-skarv ger god klingastabilitet"
  - "Fodral ingaar"
  - "Laett konstruktion paa 166 gram"
cons:
  - "Rostfria staalsringar istallet for SiC"
  - "Begransad komponentkvalitet jamfort med dyrare alternativ"
