...
Mörrumsån i Blekinge är ett av Europas mest klassiska sportfiskevatten och en av Östersjöns viktigaste vildlaxälvar. Den nedre delen drivs sedan 1941 som Mörrums Kronolaxfiske av Sveaskog och är världsberömd för sina storväxta laxar och havsöringar. Säsongen 2026 är den 86:e officella fiskepremiären. Snittvikten på fångad lax ligger historiskt runt 8 kg, laxrekordet är 26,72 kg.

Det är ett vatten med struktur och historia. 32 numrerade pooler längs den nedre sträckan, en noga reglerad fångstkvot och en laxstam som kämpar för sin återhämtning. Att fiska Mörrum är inte ett billigt dagsutflykts utan en upplevelse som kräver förberedelse.
...
- Fisken ska alltid ligga fritt i vattnet. **Aldrig lyftas över ytan** – detta är en regel, inte en rekommendation.
...
- **Beståndsstatus:** ogynnsam med historiskt negativ trend, men 2025 visade vändning uppåt.
- Fiskar över 20 kg förekommer, framför allt i maj–juni.

Bäst säsong för storlax: **mitten av maj till tidiga juni**. Mars–april ger enstaka tidiga laxar. Juli–augusti ger många mindre laxar (grilse). September avtar men kan ge bra fiske på övre sträckorna.

### Havsöring

En av Sveriges mest klassiska havsöringsälvar. Rekordet är 14,7 kg.

- Primärtid: **mars–april** för stor havsöring och blänkare.
- Andra peak: **augusti–september** för uppvandrande lekfisk.
- Hybrider (lax-öringhybrid) förekommer i Mörrum i ovanligt hög grad och registreras som egen kategori.
...
**FVO Ebbemåla–Åmma:** 3,5 km naturreservat med nio pooler, vildmarkskänsla.
...
Flugfiske är den primära metoden och obligatorisk på flera pooler. Tvåhandsspö (Spey) dominerar säsongens början.

**Spö:**
- Vårflod mars–april: tvåhandsspö 12–13 fot, klass 8–9.
- Maj–juni: switch 11 fot klass 7 eller tvåhandsspö 12 fot klass 7–8.
- Lågvatten juli–september: enhandsspö 9–10 fot klass 8, eller lätt switch.

**Linor:** Skjutsystem (Skagit eller Scandi) med utbytbara tippar är praktiskare än hela sjunkande linor.
- Mars–april (30–100 m³/s): Sink 5–7 tippar, eller Sink 4 belly + Sink 6 tip.
- Maj–juni (15–30 m³/s): Sink 3–4 eller intermediate belly med Sink 3 tip.
- Juli–september (7–15 m³/s): flytlina + intermediate eller Sink 3 tip.

**Flugor:**
- Mars–april: 5–12 cm, klara färger. Klassiker: Ullsock, Chillimps, Red Sandy, Silver Grey, Durham Ranger, Thunder and Lightning, tubflugor.
- Maj–juni: 2–8 cm, mer dämpade. Rött, gult, brunt, koppar, guld.
- Juli–september: 2–8 cm, mörka och små. Effektivt vid skymning och natt.

**Teknik:** Fiska nedströms, uppströmskast är förbjudet. Kasta i 90 graders vinkel mot strömmen vid högt vatten. Flytta dig nedströms några meter efter varje kast. Respektera fiskaren framför dig.

### Spinnfiske

**Spö:** 9–10 fot enhandsspö räcker för sommarvatten. Tvåhandsspö 8,5–10 fot vid vårflod med tunga sänken.

**Lina:** 0,30–0,40 mm nylon eller 0,15–0,20 mm flätlina.

**Beten:**
- Mars–april: 20–40 g. Toby, Mörrumsspinnaren, Myrspinnaren, Reflexspinnaren. Tubflugor med kasta-flöte är lika effektivt.
- Maj–juni: 10–30 g.
- Juli–september: 5–12 g.

Samma färglogik som för flugor: stort och färgstarkt i kallt högt vatten, litet och dämpat i varmt lågvatten.

### Säsongsspecifika tips

- **Premiär (mars):** Pool 1–4 samlar tidig fisk. Stora sjunkflugor, lugna driftar.
- **Mars–april:** havsöring är primärtarget, pool 1–16. Stora flashiga mönster.
- **Mitten av maj–tidiga juni:** storlaxsäsongen. Pool 1, 10, 11, 12, 17. Boka tidigt.
- **Juni:** vattnet sjunker, fisken sprids. Härnäs börjar fiska. Mindre flugor.
- **Juli:** lågvatten, varmt. Fiska gryning, kvällsskymning eller natt. Pool 27 (Hästhagen) anses som säkraste sommarpoolen.
...
### Övernattning på Kronolaxfisket
...
Laxens hus vid Kungsforsen rymmer reception, fiskebutik, café och en permanent utställning om Mörrumsåns historia. Strömakvarier visar levande lax och havsöring. Fönster i bottenvåningen blickar ner i ån. Inträde 50 kr för vuxen, gratis under 18 år.

### Guidning och utrustningshyra
...
- Hyrspö flugfiske: 400 kr/dag. Spinn: 300 kr/dag. Vadarbyxor med skor: 400 kr/dag.
...
Vill du testa till lägre kostnad, börja med FVO Ebbemåla–Åmma i april (300 kr/dag) eller ett eftermiddagskort på Kronolaxfisket. Guidning rekommenderas om du aldrig fiskat lax på fluga i forssatt vatten.
...
| Havsöringsrekordet | 14,7 kg (1974) |
