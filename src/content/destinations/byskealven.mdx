...
primarySpecies: ["lax", "oring", "harr", "gadda", "abborre", "sik"]
waterType: "river"
...
Allt fiske i älvfåran kräver fiskekort oavsett ålder, med ett undantag: barn och ungdomar upp till och med 17 år fiskar utan kostnad men måste hämta ett gratis kort via iFiske innan fisket påbörjas.
...
| | |
|---|---|
| Fritt handredskapsfiske | Nej (barn t.o.m. 17 år: gratis kort via iFiske) |
