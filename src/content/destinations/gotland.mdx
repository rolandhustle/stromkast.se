...
lng: 18.4867
län: "Gotland"
primarySpecies: ["havsoring", "gadda", "abborre", "flundra", "piggvar", "nabbgadda"]
waterType: "coastal"
...
Flundra förekommer i goda bestånd runt hela Gotland och är ett av öns mest stabila fiskebjudanden. Bäst under sensommar och höst. Kan fångas med bottenmete från kust, hamnar och pirar. Fredad 15 februari–15 maj.
