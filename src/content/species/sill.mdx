...
Det är samma art, *Clupea harengus*. Fisken kallas sill söder och väster om Kalmar och strömming norr om den gränsen. [Läs mer om strömmingen](/arter/stromming/) är generellt mindre och magrare än västkustsillen, och de skiljer sig något genetiskt och i antal ryggkotor.
