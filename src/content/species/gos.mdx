...
Tillväxten varierar kraftigt mellan vatten beroende på temperatur, sommarens längd och tillgång på bytesfish. Värdena i tabellen nedan är genomsnitt och bör tolkas som riktmärken, inte fasta normer. En gös i ett varmt, planktontätt söderläge kan växa dubbelt så fort som en jämngammal fisk i ett kallt, klart norrlandsvatten.
...
Gösen trivs i **stora, något grumliga och näringsrika sjöar** med siktdjup under 2,5 m. Den tolererar brackvatten upp till ca 11 ‰ salthalt men rom kräver under 2–3 ‰ för normal utveckling, vilket tvingar Östersjögösar att söka sig till sötare infjärdar för lek.
...
Bästa matfiskstorleken är **45–70 cm** (ca 1–3 kg). Filén är stor nog att ge gott utbyte, köttet är fortfarande mört, och fisken är inte könsmoget rekryteringsfisk. Stora honor på över 75 cm har viktig roll för beståndet och bör återutsättas av den som vill fiska hållbart.
