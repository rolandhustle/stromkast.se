...
export const SPECIES: SpeciesData[] = [
  {
    ...
    monthlyTips: [
      ...
      'Efterleksfönstret, alltså hungerfasen. Gäddan äter aggressivt. En av årets bästa månader.',
  ...
  },
  {
    ...
    summer:   'Öringen söker sig till svalt vatten, alltså djupa sjöar, skuggade bäckar och tidiga morgnar.',
