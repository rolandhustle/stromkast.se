...
### Klädstorlek ger inte egna sidor

**Beslut.** Plagg får en sida per modell. Storleken hålls utanför slug, titel och frontmatter. Finns modellen bara i vissa storlekar hos butiken skrivs det ut i brödtexten.

**Skäl.** Detta är tredje gången variantregeln behöver preciseras, och de tre fallen skiljer sig på en punkt: säger varianten något om produkten eller om köparen?

Rullstorlek säger något om produkten. En Shimano 1000 är en abborrulle och en 4000 en gäddrulle, alltså olika verktyg för olika fisken. Klädstorlek säger något om köparen. En vadare i XL och samma vadare i XXL är samma produkt med samma konstruktion, sula och membran. Allt en recension har att säga gäller båda.

Två praktiska förhållanden gör beslutet enkelt. Fritid och Vildmark kör Shopify, där storlek är en variant på samma produkt-URL, så en länk fungerar oavsett vad köparen väljer. FiskeOnline har separata SKU per storlek, men lagerför i augusti 2026 Kinetic ClassicGaiter enbart i XL och XXL. Det är inte ett urval utan hela lagret, och att en vadare saknas i vanliga storlekar är information läsaren behöver.

Konsekvensen är att `cupa_sku` bara följer den storlek affiliatelänken pekar på. Säljs en annan storlek via kortet syns det på kanalnivå men inte på produktnivå. Bortfallet är litet men ska vara känt innan siffrorna tolkas.

**Vad som skulle ändra det.** Att en tillverkare prissätter storlekar olika, eller att konstruktionen skiljer sig mellan dem utöver måtten. Då är de olika produkter.
